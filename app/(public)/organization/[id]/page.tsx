  ...
  return (
    <div className="bg-stone-50 min-h-screen">
      <div className="container px-4 py-8 max-w-2xl mx-auto">
        ...
        <Link
          href="/"
          className="inline-flex items-center text-sm text-stone-500 hover:text-stone-700 mb-6 transition-colors"
        >
        ...
        <div className="mb-6">
          <div className="flex flex-wrap items-center gap-2 mb-2">
            <h1 className="text-2xl md:text-3xl font-bold text-stone-800">{name}</h1>
            {spanish_available && (
        ...
        <div className="space-y-5">
          ...
          <div className="bg-white rounded-2xl border border-stone-200 overflow-hidden">
            <div className="px-5 py-4 border-b border-stone-100">
              <h2 className="text-lg font-semibold text-stone-800">Contact Information</h2>
            </div>
          ...
          <div className="bg-white rounded-2xl border border-stone-200 overflow-hidden">
            <div className="px-5 py-4 border-b border-stone-100 flex items-center gap-2">
              ...
              <h2 className="text-lg font-semibold text-stone-800">Operating Hours</h2>
            </div>
            <div className="p-5">
              <div className="space-y-2">
                {operating_hours?.map((hours) => (
                  ...
                  >
                    <span className="font-medium text-stone-700">{DAY_LABELS[hours.day]}</span>
                    <span
                      className={
                        hours.is_closed ? 'text-stone-400' : 'text-stone-600'
                      }
                    >
                      {hours.is_closed
                        ? 'Closed'
              ...
              {hours_notes && (
                <p className="mt-4 text-sm text-stone-500 bg-stone-50 p-3 rounded-xl">
                  {hours_notes}
                </p>
              )}
            </div>
          ...
          <div className="bg-white rounded-2xl border border-stone-200 overflow-hidden">
            ...
            <div className="p-5 space-y-4">
              <div>
                ...
                <div className="flex flex-wrap gap-1.5">
                  {who_served?.map((pop) => (
                    <span
                      key={pop}
                      className="px-2.5 py-1 text-xs font-medium bg-stone-100 text-stone-600 rounded-lg"
                    >
              ...
              <div>
                <p className="text-sm font-medium text-stone-500 mb-2">Cost</p>
          ...
          {donations_accepted && donations_accepted.length > 0 && (
            <div className="bg-white rounded-2xl border border-stone-200 overflow-hidden">
              <div className="px-5 py-4 border-b border-stone-100">
                <h2 className="text-lg font-semibold text-stone-800">Donations Accepted</h2>
              </div>
              <div className="p-5 space-y-4">
                <div className="flex flex-wrap gap-1.5">
                  ...
                  <div className="mt-4">
                    ...
                    <div className="space-y-1.5 text-sm">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-stone-600">Refrigerator</span>
                      </div>
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-stone-600">Freezer</span>
                      </div>
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-stone-600">Dry Storage</span>
                      </div>
                    </div>
                  </div>
                )}
          ...
          {comments && (
            <div className="bg-white rounded-2xl border border-stone-200 overflow-hidden">
              <div className="px-5 py-4 border-b border-stone-100">
                <h2 className="text-lg font-semibold text-stone-800">Additional Information</h2>
              </div>
              <div className="p-5">
                <p className="text-stone-600">{comments}</p>
              </div>
            </div>
          )}
        </div>
