...
export function OrgCard({ organization }: OrgCardProps) {
  ...
  return (
    <div className="bg-white rounded-2xl border border-stone-200 shadow-sm hover:shadow-md transition-shadow p-4 sm:p-5">
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex flex-wrap gap-1.5 mb-3">
            ...
            {assistance_types.length > 3 && (
              <span className="px-2 py-0.5 text-xs font-medium bg-stone-100 text-stone-600 rounded-md">
        ...
        <div className="flex sm:flex-col gap-2 sm:items-end">
          ...
          >
            <button className="w-full sm:w-auto px-4 py-2 bg-stone-100 hover:bg-stone-200 text-stone-700 text-sm font-medium rounded-xl transition-colors flex items-center justify-center gap-1">
